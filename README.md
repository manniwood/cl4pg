...
NOTE: ddl just means [Data Definition Language](http://en.wikipedia.org/wiki/Data_definition_language). 
It's the method you'll want to use when you want to create or drop tables, indexes, sequences, etc.
